  ...
  sequential_action:
    ...
    steps:
      ...
      - step:
          ...
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
          default_args: '"Hello and welcome ro"'
      ...
      - step:
          ...
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
          default_args: '"to Micro Focus RPA!!"'
      ...
      - step:
          ...
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
          default_args: "\"We're done some work for you \""
      ...
      - step:
          ...
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
          default_args: '"ese are the results:"'
      ...
      - step:
          ...
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
          default_args: '"user we looked up is xxxx"'
      ...
      - step:
          ...
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
          default_args: "\"That's it. Have a nice day!\""
    ...
    - object:
        ...
        child_objects:
          - object:
              ...
              class: WinEditor
              visual_relations: ''
              last_update_time: 'Tuesday, 22 December 2020 14:20:46'
